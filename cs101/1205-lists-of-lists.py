...
def total_enrollment(usa_univs):
    num_student, total_tuition = 0, 0
    for i in range(len(usa_univs)):
        num_student += usa_univs[i][1]
        total_tuition += usa_univs[i][1]*usa_univs[i][2]
    return num_student, total_tuition

def total_enrollment(p):
    num_student, total_tuition = 0, 0
    for name, student, tuition in p:
        num_student += student
        total_tuition += student*tuition
    return num_student, total_tuition
